...
const ToolbarServ = function( props ){
      const { form } = props;
            ...
            <div className="toolbar-wrapper" >
                <Form className="toolbar-form" layout="inline">
                        ...
                        {getFieldDecorator('order_number')(
                            <Input style={ formItemStyle }  placeholder="请输入售后单号" />
                        )}
                        </Form.Item>
                        ...
                        <Form.Item >
                            {getFieldDecorator('order_channel')(
                                <Select style={ formItemStyle } placeholder="售后类型" >
...
export default Form.create()( ToolbarServ );